                        ...
                        <c:forEach var = "row" items = "${result.rows}">
                            <tr>
                                ...
                                <td><div class="btn-group d-flex" role="group" >
                                        <a role="button" class="btn btn-primary">View</a>
                                <c:if test='${row.total!="4"}'>
                                    <c:out escapeXml="false" value = "<a role=\"button\" href=\"/Staff/InformationStudent.jsp?number=${row.number}&level=${row.level}&block=${row.block}\" class='btn btn-success '>Information</a>"/>
                                </c:if>
                                    </div></td>
                            </tr>   
                        </c:forEach>
