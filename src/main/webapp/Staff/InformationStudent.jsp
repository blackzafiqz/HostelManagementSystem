                    ...
                    <div class="container">
                        <form id="form" method="post" action="/RoomServlet">
                            <div class="row">
                                ...
                                <div class="col">
                                    <input type="number" id="studentid" name="studentid" required class="form-control" value=""/>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                ...
                                <div class="col">
                                    <input type="text" id="name" class="form-control-plaintext" readonly value=""/>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <select id="block" name="block" class="form-control" <%=occupy ? "disabled" : ""%> onchange="showLevel(this.value)">
                                       <%=request.getParameter("block")==null ? "" : "<option selected>"+request.getParameter("block")+"</option>"%>
                                        <option hidden>Select Block</option>
                                        <%
                                            ArrayList<String> blocks = new ArrayList<String>();
                                            for (Room room : new RoomDAO().ReadAvailable()) {
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <select id="level" name="level" class="form-control" <%=occupy ? "disabled" : ""%>  onchange="showRoom(this.value)">
                                        <%=request.getParameter("level")==null ? "" : "<option selected>"+request.getParameter("level")+"</option>"%>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <select id="room" name="room" class="form-control " <%=occupy ? "disabled" : ""%>>
                                        <%=request.getParameter("number")==null ? "" : "<option selected>"+request.getParameter("number")+"</option>"%>
